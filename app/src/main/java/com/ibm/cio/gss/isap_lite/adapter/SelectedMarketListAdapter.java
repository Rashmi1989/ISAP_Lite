...
public class SelectedMarketListAdapter extends RecyclerView.Adapter<SelectedMarketListAdapter.MyViewHolder> {
    private List<REGION> marketsList;
    private REGION marketDetailList;
    public  Context ctx;
    ...
    public SelectedMarketListAdapter(List<REGION> marketsList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder,int position) {
        ...
        marketDetailList = marketsList.get(position);
        holder.initiativeNameLabel.setText(marketDetailList.getNAME());
