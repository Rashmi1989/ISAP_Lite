...
public class LinkedSelectedGoalsListAdapter extends RecyclerView.Adapter<LinkedSelectedGoalsListAdapter.MyViewHolder> {

    private List<GOALS> goalsList;
    private GOALS goalDetailsList;
    public  Context ctx;
    ...
    public LinkedSelectedGoalsListAdapter(List<GOALS> goalsList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder,int position) {
      try{
        ...
        holder.initiativeNameLabel.setText(goalDetailsList.getVALUE());
