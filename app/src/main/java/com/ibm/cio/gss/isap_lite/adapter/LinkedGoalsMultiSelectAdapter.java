...
public class LinkedGoalsMultiSelectAdapter extends RecyclerView.Adapter<LinkedGoalsMultiSelectAdapter.MyViewHolder> {

    private List<GOALS> strategicimperativesList;
    private Map<Integer,Boolean> choiceMap;
    private GOALS strategicimperativesDetailList;
    public  Context ctx;
    ...
    public LinkedGoalsMultiSelectAdapter(List<GOALS> strategicimperativesList, Map<Integer,Boolean> choiceMap) {
