...
public class SelectedCountryListAdapter extends RecyclerView.Adapter<SelectedCountryListAdapter.MyViewHolder> {
 private List<COUNTRY> countryList;
    ...
    public SelectedCountryListAdapter(List<COUNTRY> countryList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder,int position) {
        ...
        countryDetailList = countryList.get(holder.getAdapterPosition());
