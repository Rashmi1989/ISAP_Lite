...
public class GeoMultiSelectListAdapter extends RecyclerView.Adapter<GeoMultiSelectListAdapter.MyViewHolder> {

    private List<GEO> geoList;
    private Map<Integer, Boolean> choiceMap;
    private GEO geoDetailsList;
    public Context ctx;
    ...
    public GeoMultiSelectListAdapter(List<GEO> geoList, Map<Integer, Boolean> choiceMap) {
        this.geoList = geoList;
        this.choiceMap = choiceMap;
        listCheckbox = new boolean[geoList.size()];
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                    if (isChecked) {
                        if (position == 0) {
                            ...
                            NewInitiativeActivity.isAllGeos=false;
                            for (int i = 0; i < listCheckbox.length; i++) {
                                if (i == 0) {
